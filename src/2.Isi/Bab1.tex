...
luas di Ogan Komering Ilir, Sumatera Selatan. Mengingat jumlah tenaga kerja yang
mencapai ribuan orang, mengelola administrasi harian di lapangan menjadi
tantangan yang tidak sepele bagi perusahaan. Setiap hari, tim lapangan harus
menangani proses pendataan karyawan baru, penerbitan surat izin keluar, hingga
pengajuan klaim penggantian biaya transportasi.
...
demi keuntungan pribadi. Hal-hal seperti ini jelas merugikan perusahaan secara finansial. Penerapan validasi relasional yang ketat pada tingkat sistem dinilai penting untuk menjaga integritas data transaksi sekaligus menutup celah kecurangan tersebut \cite{zulkarnain2026validasi}.
